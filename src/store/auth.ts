...
export const useAuthStore = defineStore('auth', () => {
  ...
  async function registerUser(): Promise<boolean> {
    try {
      const response = await axios.post('api/otp/register/', {
        ...
        "business_type": registration.value.businessType,
      ...
      // await axios.post('api/otp/login/', {
      //   identifier: registration.value.phone
      // })
